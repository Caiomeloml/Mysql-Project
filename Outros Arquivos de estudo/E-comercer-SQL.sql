...
create table Credcard(
	...
	credcardNumver varchar(16) unique not null,
...
create table Boletos(
    ...
    GerarBoleto int unique not null
    );
...
create table orders(
    ...
    idOrderCLient int,
    orderStatus enum('Em Andamento', 'Processando', 'Enviado', 'Entregue') not null,
